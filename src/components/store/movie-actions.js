  ...
  return async () => {
    const sendMovies = async () => {
      const response = await fetch(
        `https://netflix-6d4f5-default-rtdb.firebaseio.com/${type}.json`,
        {
          method: "PUT",
...
export const getAllData = () => {
  return async (dispatch) => {
    const fetchData = async () => {
      ...
      const response = await fetch(
        "https://netflix-6d4f5-default-rtdb.firebaseio.com/movies.json"
      );
...
export const getList = () => {
  return async (dispatch) => {
    const getDataBack = async () => {
      const response = await fetch(
        "https://netflix-6d4f5-default-rtdb.firebaseio.com/list.json"
      );
